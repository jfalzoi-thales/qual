...
cp qual.service $RPM_BUILD_ROOT/usr/lib/systemd/system/
...
%files
/usr/lib/systemd/system/qual.service
/etc/systemd/system/multi-user.target.wants/qual.service
/thales/qual/src/*

%changelog
* Mon Jun 20 2016 Christopher Wallace <cwallace@tklabs.com> 1.0-1
