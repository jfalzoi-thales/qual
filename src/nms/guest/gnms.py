...
class GnmsGpbListener(ThalesZMQServer):
    ...
    def __init__(self, gnms):
        ...
        self.gnms = gnms
        # Init the superclass
        super(GnmsGpbListener, self).__init__(address=gnms.service_address, allowNoBody=True, prvKeyFile=gnms.service_prvkey_file, pubKeysDir=gnms.client_pubkeys_dir)
