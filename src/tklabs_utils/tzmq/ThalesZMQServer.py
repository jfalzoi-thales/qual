...
class ThalesZMQServer(object):
    ...
    def __init__(self, address, msgParts=3, requestParts=0, responseParts=0, allowNoBody=False, privKeyFile="",
                 pubKeysDir=""):
        ...
        ## File containing private and public curve authentication keys
